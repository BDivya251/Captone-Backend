...
public class PDFService {
    ...
    private PdfPTable createDetailsTable(Map<String, Object> data) throws DocumentException {
        ...
        addRow(table, "Service ID:", String.valueOf(data.get("serviceRequestId")));
        addRow(table, "Type:", String.valueOf(data.get("requestType")));
        addRow(table, "Status:", String.valueOf(data.get("status")));
        addRow(table, "Bay:", String.valueOf(data.get("bayNumber")));
        addRow(table, "Date:", String.valueOf(data.get("completedDate")));
    ...
    private PdfPTable createPartsTable(Map<String, Object> data) throws DocumentException {
        java.util.List<Object> parts = (java.util.List<Object>) data.get("partsUsed");
        ...
        for (Object part : parts) {
            if (part instanceof Map) {
                ...
                table.addCell(new PdfPCell(new Phrase(String.valueOf(p.get("partName")))));
